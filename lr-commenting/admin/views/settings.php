                                ...
                                <div class="lr-row">
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <input type="text" name="LR_Commenting_Settings[commenting_title]" class="lr-row-field" value= "<?php echo htmlspecialchars($lr_commenting_settings['commenting_title']); ?>" />
                                             <span class="errorMessageCommentTitile" style="display: none;">Please Enter Comment Title</span>
                                        </label>
                                    </div>
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <span class="errorMessageCommentMsg" style="display: none;">Please Enter Comment Message</span>
                                        </label>
                                    </div>
                                </div>
