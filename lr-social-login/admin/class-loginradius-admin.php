...
if ( ! class_exists( 'LR_Social_Login_Admin') ) {
    ...
    class LR_Social_Login_Admin {
        ...
        public function admin_init() {
            ...
            if ( $pagenow == 'profile.php' && isset( $_REQUEST['token'] ) && ((! isset($loginradius_api_settings['raas_enable']) || $loginradius_api_settings['raas_enable'] != 1 ))) {
        ...
        public static function account_linking_info_on_profile_page() {
            global $pagenow, $lr_custom_interface_settings,$loginradius_api_settings;
