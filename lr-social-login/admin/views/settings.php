    ...
    class LR_Social_Login_Admin_Settings {
        ...
        private static function help_options() {
            ...
            <div class="lr-sidebar">
                <div class="lr-frame">
                    ...
                    <div>
                        <a target="_blank" href="http://ish.re/1ESZ2"><?php _e('Plugin Installation, Configuration and Troubleshooting', 'lr-plugin-slug'); ?></a>
                        <a target="_blank" href="http://ish.re/1ESZF"><?php _e('How to get LoginRadius API Key & Secret', 'lr-plugin-slug'); ?></a>
                        <a target="_blank" href="http://ish.re/1ESZK"><?php _e('WP Multisite Feature', 'lr-plugin-slug'); ?></a>
                        <a target="_blank" href="http://ish.re/96M7"><?php _e('About LoginRadius', 'lr-plugin-slug'); ?></a>
                        <a target="_blank" href="http://ish.re/13PNO"><?php _e('LoginRadius Products', 'lr-plugin-slug'); ?></a>
                        <a target="_blank" href="http://ish.re/C8E7"><?php _e('Social Plugins', 'lr-plugin-slug'); ?></a>
                        <a target="_blank" href="http://ish.re/1ET00"><?php _e('Social SDKs', 'lr-plugin-slug'); ?></a>
                    </div>
                </div>
            </div>
            <?php
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('User is redirected to the page after registration', 'lr-plugin-slug'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                            ...
                            <label>
                                ...
                                <span><?php _e('Redirect to a custom URL', 'lr-plugin-slug'); ?></span>
                                <?php
                                if (isset($loginRadiusSettings['custom_regRedirect']) && $loginRadiusSettings['LoginRadius_regRedirect'] && $loginRadiusSettings['LoginRadius_regRedirect'] == 'custom') {
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('User is redirected to the page after logout [Note: The logout function only works when clicking \'Logout\' in the social login widget area. In all other cases, WordPress\' default logout function will be applied.]', 'lr-plugin-slug'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <label>
                                ...
                                <input type="text" name="LoginRadius_settings[LoginRadius_title]" style="margin-left:280px;width:300px;" value= "<?php if (isset($loginRadiusSettings['LoginRadius_title'])) {
                            echo htmlspecialchars($loginRadiusSettings['LoginRadius_title']);
                        } ?>" />
                            </label>
                        </div>
        ...
        private static function advanced_options($loginRadiusSettings) {
            ...
            <?php _e('Select whether you would like to control account activation and deactivation', 'lr-plugin-slug'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('You can enable/disable users from the status column of the user page.', 'lr-plugin-slug'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
            ...
            <?php _e("Enable account linking", 'lr-plugin-slug'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('Select yes if you want to enable social account linking.This option will also show users, the linking interface on the wordpress dashboard, that allows users to link their social providers.', 'lr-plugin-slug'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
