...
function login_radius_email_popup() {
    ...
    if (isset($_GET['key']) && $_GET['key'] != '') {
        ...
        if (isset($lr_social_profile_data_settings['enable_custom_popup']) && $lr_social_profile_data_settings['enable_custom_popup'] == '1') {
            ...
            <?php if (!$has_email && $notdummyemail && ( isset($lr_social_profile_data_settings['show_email']) && $lr_social_profile_data_settings['show_email'] == '1' || isset($loginRadiusSettings['LoginRadius_dummyemail']) && $loginRadiusSettings['LoginRadius_dummyemail'] == 'notdummyemail' )) { ?>
                            <div>
...
function login_radius_change_user_status() {
    global $accountAPIObject,$loginradius_api_settings;
    ...
    if (isset($loginradius_api_settings['raas_enable']) && $loginradius_api_settings['raas_enable'] == 1) {
        ...
        try {
            $accountAPIObject->setStatus($uid, !$currentStatus);
