...
if (!class_exists('LR_Social_Profile_Data_Admin_Settings')) {
    ...
    class LR_Social_Profile_Data_Admin_Settings {
        ...
        public static function render_options_page() {
            global $wpdb, $loginradius_api_settings;
            LR_Social_Profile_Data::reset_options();
            ...
            <?php if (class_exists('LR_Social_Login') && (!isset($loginradius_api_settings['raas_enable']) || $loginradius_api_settings['raas_enable'] != 1)) { ?>
                                    <div>
            ...
            <?php } ?>
                            ...
                            <div class="lr-row">
                                <h5>
            <?php _e('Please visit the following section to see the complete listing of supported Data points using LoginRadius API: ', 'lr-plugin-slug'); ?><a href="//www.loginradius.com/datapoints" target="_blank"><?php _e('here', 'lr-plugin-slug'); ?></a>
                                </h5>
                            </div>
                        </div>
