...
      });
    ...
    jQuery('#lrAdvanceSetting').find('input[type="submit"]').addClass('advanceSettings');
    popUpHideShow();
    jQuery('input[name="LoginRadius_share_settings[popupHeightWidth]"]').click(function(){
        popUpHideShow();
        
    })
        
        jQuery('input[name="LoginRadius_share_settings[popupWindowHeight]"], input[name="LoginRadius_share_settings[popupWindowWidth]"]').blur(function(){
        if(jQuery('input[name="LoginRadius_share_settings[popupHeightWidth]"]:checked').val() == '1'){ 
            if(jQuery('input[name="LoginRadius_share_settings[popupWindowHeight]"]').val() == '' ){
                jQuery(".errorMessageHeight").show();
            }            
            if(jQuery('input[name="LoginRadius_share_settings[popupWindowWidth]"]').val() == ''){
            ...
            if((jQuery('input[name="LoginRadius_share_settings[popupWindowWidth]"]').val() != '') && (jQuery('input[name="LoginRadius_share_settings[popupWindowHeight]"]').val() != '')){
    ...
    jQuery('input[name="LoginRadius_share_settings[popupHeightWidth]"]').click(function(){
        if(jQuery('input[name="LoginRadius_share_settings[popupHeightWidth]"]:checked').val() == '1' && (jQuery('input[name="LoginRadius_share_settings[popupWindowHeight]"]').val() != '')||( jQuery('input[name="LoginRadius_share_settings[popupWindowWidth]"]').val() != '' )){
