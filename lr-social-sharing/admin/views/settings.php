...
if ( ! class_exists('LR_Social_Share_Settings') ) {
    ...
    class LR_Social_Share_Settings {
        ...
        private static function counter_provider() {
            return array('Facebook Like', 'Twitter Tweet', 'StumbleUpon Badge', 'Google+ Share', 'Facebook Recommend', 'Pinterest Pin it', 'Reddit',  'Facebook Send', 'LinkedIn Share', 'Google+ +1');
        }
                ...
                <div class="lr_options_container">
                    ...
                    <div class="lr-row" id="login_radius_horizontal_rearrange_container">
                        ...
                        <ul id="loginRadiusHorizontalSortable" class="cf">
                            ...
                            if (isset($settings['horizontal_rearrange_providers']) && !empty($settings['horizontal_rearrange_providers']) && count($settings['horizontal_rearrange_providers']) > 0) {
                ...
                <div class="lr_options_container">
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            ...
                            <h4 class="advanceOptionFontSize"><?php _e('Mobile Friendly', 'lr-plugin-slug'); ?>
                        ...
                        <label>
                            <input type="radio" class="email_content" name="LoginRadius_share_settings[mobile_enable]" value="true" <?php echo ( ! isset( $settings['mobile_enable'] ) || $settings['mobile_enable'] == 'true' ) ? 'checked' : ''; ?> /> 
                            <span class="advanceOptionFontSize"><?php _e('True', 'lr-plugin-slug'); ?></span>
                        </label>
                        <label>
                            <input type="radio" class="email_content" name="LoginRadius_share_settings[mobile_enable]" value="false" <?php echo ( ! isset( $settings['mobile_enable'] ) || $settings['mobile_enable'] == 'false' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('False', 'lr-plugin-slug'); ?></span>
                        </label>
                            
                            <label>
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Please enter your desired email message', 'lr-plugin-slug' ); ?></span>
                           
                            <input type="text" class="advanceOptionTextBox lr-row-field advanceOptionFontSize" name="LoginRadius_share_settings[emailMessage]" value="<?php echo (isset ($settings['emailMessage']) && !empty($settings['emailMessage']) ? $settings['emailMessage'] : '') ?>" />
                        </label>
                        <label>
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Please enter your desired email subject', 'lr-plugin-slug' ); ?></span>
                            <input type="text" class="advanceOptionTextBox advanceOptionFontSize lr-row-field" name="LoginRadius_share_settings[emailSubject]" value="<?php echo (isset ($settings['emailSubject']) && !empty($settings['emailSubject']) ? $settings['emailSubject'] : '') ?>"/>
                        </label>
                        
                         
                        <h4 class="advanceOptionFontSize"><?php _e('Do you want to make the email content read only? ', 'lr-plugin-slug'); ?>
                        <span class="lr-tooltip tip-bottom" data-title="<?php _e(' Your readers wont be able to change the Email Content if its read only', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h4> 
                        <label>
                            <input type="radio" class="email_content" name="LoginRadius_share_settings[emailcontent]" value="true" <?php echo ( ! isset( $settings['emailcontent'] ) || $settings['emailcontent'] == 'true' ) ? 'checked' : ''; ?> /> 
                            <span class="advanceOptionFontSize"><?php _e('True', 'lr-plugin-slug'); ?></span>
                        </label>
                        <label>
                            <input type="radio" class="email_content" name="LoginRadius_share_settings[emailcontent]" value="false" <?php echo ( ! isset( $settings['emailcontent'] ) || $settings['emailcontent'] == 'false' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('False', 'lr-plugin-slug'); ?></span>
                        </label>
                        ...
                        <label>
                        <h4 class="advanceOptionFontSize"><?php _e('Do you want to use short URL during sharing? ', 'lr-plugin-slug'); ?>
                        <span class="lr-tooltip tip-bottom" data-title="<?php _e(' Enable this if you want the URL to be shortened using Ish.re', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h4> 
                        <label>
                            <input type="radio" class="shorten_url" name="LoginRadius_share_settings[shortenUrl]" value="true"  <?php echo ( ! isset( $settings['shortenUrl'] ) || $settings['shortenUrl'] == 'true' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('True', 'lr-plugin-slug'); ?></span>
                        </label>
                        <label>
                            <input type="radio" class="shorten_url" name="LoginRadius_share_settings[shortenUrl]" value="false" <?php echo ( ! isset( $settings['shortenUrl'] ) || $settings['shortenUrl'] == 'false' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('False', 'lr-plugin-slug'); ?></span>
                        </label>
                        </label>
                        
                        <label>
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Enter your Facebook App ID', 'lr-plugin-slug' ); ?>
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e(' Enter the Facebook App Id if you want to track social sharing on your Facebook app', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                            </span>
                            <input type="text" class="advanceOptionTextBox lr-row-field" name="LoginRadius_share_settings[facebookAppId]" value="<?php echo (isset ($settings['facebookAppId']) && !empty($settings['facebookAppId']) ? $settings['facebookAppId'] : '') ?>" />
                        </label>    
                        
                                        
                        <h4 class="advanceOptionFontSize"><?php _e('Do you want to enable Total Share to display the total share count on your website?', 'lr-plugin-slug'); ?>
                        <span class="lr-tooltip tip-bottom" data-title="<?php _e(' Display the total shares URL got from all social providers', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h4> 
                        <label>
                            <input type="radio" class="shorten_url" name="LoginRadius_share_settings[isTotalShare]" value="true"  <?php echo ( ! isset( $settings['isTotalShare'] ) || $settings['isTotalShare'] == 'true' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('True', 'lr-plugin-slug'); ?></span>
                        </label>
                        <label>
                            <input type="radio" class="shorten_url" name="LoginRadius_share_settings[isTotalShare]" value="false" <?php echo ( ! isset( $settings['isTotalShare'] ) || $settings['isTotalShare'] == 'false' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('False', 'lr-plugin-slug'); ?></span>
                        </label>
                        
                        <h4 class="advanceOptionFontSize"><?php _e('Do you want to open all providers in a single window? ', 'lr-plugin-slug'); ?>
                        <span class="lr-tooltip tip-bottom" data-title="<?php _e(' Disabling this opens all sharing providers in a new Popup', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h4> 
                        <label>
                            <input type="radio" class="shorten_url" name="LoginRadius_share_settings[isOpenSingleWindow]" value="true"  <?php echo ( ! isset( $settings['isOpenSingleWindow'] ) || $settings['isOpenSingleWindow'] == 'true' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('True', 'lr-plugin-slug'); ?></span>
                        </label>
                        <label>
                            <input type="radio" class="shorten_url" name="LoginRadius_share_settings[isOpenSingleWindow]" value="false" <?php echo ( ! isset( $settings['isOpenSingleWindow'] ) || $settings['isOpenSingleWindow'] == 'false' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('False', 'lr-plugin-slug'); ?></span>
                        </label>
                        
                       <label id="customPopUpLabel">
                            <input type="checkbox" class="popupHeightWidth shorten_url" name="LoginRadius_share_settings[popupHeightWidth]" value="1" <?php echo ( isset( $settings['popupHeightWidth'] ) && $settings['popupHeightWidth'] == '1' ) ? 'checked' : ''; ?>/> 
                            <span class="advanceOptionFontSize"><?php _e('Use Custom Popup Window Size', 'lr-plugin-slug'); ?>
                             <span class="lr-tooltip tip-bottom" data-title="<?php _e('Check this if you want to change default Popup Window Size. [Default Size 530*530 Px]', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                            </span>
                        </label>
                        <div id="popupArea" style="display: none;">
                         <label>
                            <span class="advanceOptionSpan lr_property_title advanceOptionFontSize"><?php _e( 'Enter Height', 'lr-plugin-slug' ); ?></span>
                             <input type="number" placeholder="530px" class="advanceOptionTextBox lr-row-field" name="LoginRadius_share_settings[popupWindowHeight]" value="<?php echo (isset ($settings['popupWindowHeight']) && !empty($settings['popupWindowHeight']) ? $settings['popupWindowHeight'] : '') ?>" />
                            <span class="errorMessageHeight" style="display: none;">Please Enter Height</span>
                        </label>  
                         <label>
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Enter Width', 'lr-plugin-slug' ); ?>
                            
                            </span>
                            <input type="number" placeholder="530px" class="advanceOptionTextBox lr-row-field" name="LoginRadius_share_settings[popupWindowWidth]" value="<?php echo (isset ($settings['popupWindowWidth']) && !empty($settings['popupWindowWidth']) ? $settings['popupWindowWidth'] : '') ?>" />
                             <span class="errorMessageWidth" style="display: none;">Please Enter Width</span>
                        </label>
                        </div>
                        <label style="margin-top:20px;">
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Enter your desired Twitter handle to mention during a Twitter share.', 'lr-plugin-slug' ); ?>
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e('Handle will be mentioned as suffix as &OpenCurlyDoubleQuote;via @twitterhandle&CloseCurlyDoubleQuote;', 'lr-plugin-slug'); ?>">
                                
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                            </span>
                            <input type="text" class="advanceOptionTextBox lr-row-field" name="LoginRadius_share_settings[twittermention]" value="<?php echo (isset ($settings['twittermention']) && !empty($settings['twittermention']) ? $settings['twittermention'] : '') ?>" />
                        </label>  
                        
                        <label>
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Enter your desired Twitter hash tags to be used during a Twitter share', 'lr-plugin-slug' ); ?>
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e('Hashtag will be added to all tweets', 'lr-plugin-slug'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                            </span>
                            <input type="text" class="advanceOptionTextBox lr-row-field" name="LoginRadius_share_settings[twitterhashtags]" value="<?php echo (isset ($settings['twitterhashtags']) && !empty($settings['twitterhashtags']) ? $settings['twitterhashtags'] : '') ?>" />
                        </label>
                        
                        <label class="customOptionLabel">
                            <span class="advanceOptionSpan advanceOptionFontSize lr_property_title"><?php _e( 'Please enter custom options for sharing interface', 'lr-plugin-slug' ); ?>

                            </span>
                            <textarea name="LoginRadius_share_settings[customOptions]" id="customOptions" class="advanceOptionTextBox customOptionsCss"><?php echo (isset ($settings['customOptions']) && !empty($settings['customOptions']) ? $settings['customOptions'] : '') ?></textarea>
                        <span class="customOptionText">Choose form the list of options you want to customize from the <a target='_blank' href='http://support.loginradius.com/hc/en-us/articles/211058363'>link</a></span>
                        </label>
        ...
        public static function render_options_page() {
            ...
            <div class="wrap lr-wrap cf">
                ...
                <div id="lr_options_tabs" class="cf">
                    ...
                    <!-- Settings -->
                    <form id="lrAdvanceSetting" method="post" action="options.php">
                        <?php
